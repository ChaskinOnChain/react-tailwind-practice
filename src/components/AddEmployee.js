            ...
            <Modal show={show} onHide={handleClose} backdrop="static" keyboard={false}>
                ...
                <Modal.Body>
                    <form
                        ...
                        onSubmit={(e) => {
                            e.preventDefault()
                            props.addChange(inputValueName, inputValueRole, inputValueImageUrl)
                            setInputValueName("")
                            setInputValueRole("")
                            setInputValueImageUrl("")
                            handleClose()
                        }}
                    >
                        ...
                        <div className="md:flex md:items-center mb-6">
                            ...
                            <div className="md:w-2/3">
                                <input
                                    ...
                                    id="img"
                                    type="text"
                                    value={inputValueImageUrl}
                                    onChange={(e) => setInputValueImageUrl(e.target.value)}
                                />
                            </div>
                        </div>
                    </form>
